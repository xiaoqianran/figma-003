...
const Component = () => {
  return (
    <div className={styles.payment2}>
      <img
        src="../image/mpqqns0u-xyn1nbi.svg"
        className={styles.systemStatusBarsBlac}
      />
      <div className={styles.payment}>
        <img
          src="../image/mpqqns0u-e32y6si.svg"
      ...
      <div className={styles.paymentOffers}>
        ...
        <div className={styles.rectangle421}>
          <img
            src="../image/mpqqns0u-fu11t4t.svg"
            className={styles.iconsCreditCard2}
          />
        ...
        <div className={styles.rectangle4212}>
          <img
            src="../image/mpqqns0u-35edu1w.svg"
            className={styles.iconsCreditCard2}
          />
      ...
      <div className={styles.promotions}>
        ...
        <div className={styles.rectangle4162}>
          <img
            src="../image/mpqqns0u-axzru98.svg"
            className={styles.iconsCreditCard2}
          />
          <p className={styles.earnGodyCashWithVisa}>Vouchers</p>
          <img
            src="../image/mpqqns0u-l8nbh4a.svg"
