...
> **🚀 Live Demo**: [https://xiaoqianran.github.io/figma-003/](https://xiaoqianran.github.io/figma-003/)

## Quick Links

- 🚀 **Live Demo** — [https://xiaoqianran.github.io/figma-003/](https://xiaoqianran.github.io/figma-003/)
- 📖 **Migration Report** — [MIGRATION.md](./MIGRATION.md)
- 📁 **React Source** — [`src/`](./src/) (44 real page components)
- 🗂️ **Legacy Static Prototypes** — [`legacy-html/`](./legacy-html/)
